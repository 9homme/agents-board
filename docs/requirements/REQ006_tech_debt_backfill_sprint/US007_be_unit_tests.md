# US007 — Backend unit & integration test specification
...
- **Architecture cite:** US007 AC exact validation string
...
- **Architecture cite:** US007 AC `_EmptySliceReturnsEmptyArray`
