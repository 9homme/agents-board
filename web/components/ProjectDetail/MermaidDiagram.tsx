...
export const MermaidDiagram = ({ source }: MermaidDiagramProps): React.ReactElement => {
  ...
  if (renderState.status === 'success') {
    const { svg, ariaLabel } = renderState;
    return (
      <div
        role="img"
        aria-label={ariaLabel || undefined}
        style={{ maxWidth: '100%', overflowX: 'auto' }}
        // The SVG is generated by mermaid (not raw user input) with securityLevel:'strict'.
        // dangerouslySetInnerHTML here is the single sanctioned use per architecture D-004.
