...
- **Then:** Returns `true`.
- **Architecture cite:** US008 AC "Review cycle transitions".
...
- **Then:** Returns `true`.
- **Architecture cite:** US008 AC "Circuit breaker transition".
...
- **Architecture cite:** US008 AC "Enforce initial state on creation".
