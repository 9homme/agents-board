# US019 — Backend unit & integration test specification
...
|---|---|---|---|---|
| CreateDocument generic DB error | unit | UT-US019-001 | services/agent-board / internal/repo | `DocumentRepo.CreateDocument` |
| GetDocument generic DB error | unit | UT-US019-002 | services/agent-board / internal/repo | `DocumentRepo.GetDocument` |
| UpdateDocument not found (ErrNoRows) | unit | UT-US019-003 | services/agent-board / internal/repo | `DocumentRepo.UpdateDocument` |
| UpdateDocument generic DB error | unit | UT-US019-004 | services/agent-board / internal/repo | `DocumentRepo.UpdateDocument` |
| DeleteDocument generic DB error | unit | UT-US019-005 | services/agent-board / internal/repo | `DocumentRepo.DeleteDocument` |
| ListDocuments query error | unit | UT-US019-006 | services/agent-board / internal/repo | `DocumentRepo.ListDocuments` |
| ListDocuments scan error | unit | UT-US019-007 | services/agent-board / internal/repo | `DocumentRepo.ListDocuments` |
| ListDocuments rows error | unit | UT-US019-008 | services/agent-board / internal/repo | `DocumentRepo.ListDocuments` |
| CreateProject generic DB error | unit | UT-US019-009 | services/agent-board / internal/repo | `ProjectRepo.CreateProject` |
| GetProject generic DB error | unit | UT-US019-010 | services/agent-board / internal/repo | `ProjectRepo.GetProject` |
| UpdateProject not found (ErrNoRows) | unit | UT-US019-011 | services/agent-board / internal/repo | `ProjectRepo.UpdateProject` |
| UpdateProject generic DB error | unit | UT-US019-012 | services/agent-board / internal/repo | `ProjectRepo.UpdateProject` |
| DeleteProject generic DB error | unit | UT-US019-013 | services/agent-board / internal/repo | `ProjectRepo.DeleteProject` |
| ListProjects query error | unit | UT-US019-014 | services/agent-board / internal/repo | `ProjectRepo.ListProjects` |
| ListProjects scan error | unit | UT-US019-015 | services/agent-board / internal/repo | `ProjectRepo.ListProjects` |
| ListProjects rows error | unit | UT-US019-016 | services/agent-board / internal/repo | `ProjectRepo.ListProjects` |

## Unit tests

The 16 test function names below are VERBATIM as specified by architecture §5.1 and §5.2. The dev MUST use these exact names — the test report maps UT-US019-NNN IDs to these function names.

### Document repo — 8 new test functions in `document_repo_test.go`

### UT-US019-001 — `TestDocumentRepo_CreateDocument_GenericError`
...
### UT-US019-002 — `TestDocumentRepo_GetDocument_GenericError`
...
### UT-US019-003 — `TestDocumentRepo_UpdateDocument_NotFound`
...
### UT-US019-004 — `TestDocumentRepo_UpdateDocument_GenericError`
...
### UT-US019-005 — `TestDocumentRepo_DeleteDocument_GenericError`
...
### UT-US019-006 — `TestDocumentRepo_ListDocuments_QueryError`
...
### UT-US019-007 — `TestDocumentRepo_ListDocuments_ScanError`
...
### UT-US019-008 — `TestDocumentRepo_ListDocuments_RowsErr`
...
### UT-US019-009 — `TestProjectRepo_CreateProject_GenericError`
...
### UT-US019-010 — `TestProjectRepo_GetProject_GenericError`
...
### UT-US019-011 — `TestProjectRepo_UpdateProject_NotFound`
...
### UT-US019-012 — `TestProjectRepo_UpdateProject_GenericError`
...
### UT-US019-013 — `TestProjectRepo_DeleteProject_GenericError`
...
### UT-US019-014 — `TestProjectRepo_ListProjects_QueryError`
...
### UT-US019-015 — `TestProjectRepo_ListProjects_ScanError`
...
### UT-US019-016 — `TestProjectRepo_ListProjects_RowsErr`
