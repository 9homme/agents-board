# US006 — Backend unit & integration test specification
...
- **Then:**
  ...
  - `err` is `nil`
- **Architecture cite:** US006 AC `_DefaultStatusWhenOmitted`
...
- **Architecture cite:** US006 AC `_InvalidInitialStatus`; `domain.NewTask` validation
...
- **Architecture cite:** US006 AC `_StatusChange_HappyPath`
