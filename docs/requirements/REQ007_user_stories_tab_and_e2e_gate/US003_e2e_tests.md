...
**Owner:** tester. Implemented in `tests/e2e/REQ007_user_stories_tab_and_e2e_gate/US003_e2e_pr_quality_gate.robot`.

## Why e2e
US003 introduces a GitHub Actions workflow. E2E verifies that the `.github/workflows/e2e.yml` file is created with the correct triggers, setup steps, and teardown logic per the ACs.

## Scenarios
### E2E-US003-001 — GitHub Actions workflow is correctly configured
- **Tag:** US003
- **Preconditions:** None.
- **Steps:** 
