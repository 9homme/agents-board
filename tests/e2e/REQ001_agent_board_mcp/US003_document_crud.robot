...
Scenario: Full Document CRUD Lifecycle
    ...
    ${resp}=    Create Project Tool    ${session_id}    Doc Project    ${EMPTY}    /e2e/us003-doc
    ...
    # Create Document
    ${resp}=    Create Document Tool    ${session_id}    ${project_id}    ${requirement_id}    Test Doc    Some content
