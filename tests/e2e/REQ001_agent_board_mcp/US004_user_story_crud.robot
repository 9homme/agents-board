...
Scenario: Full User Story CRUD Lifecycle
    ...
    # Create Story
    ${resp}=    Create User Story Tool    ${session_id}    ${project_id}    ${requirement_id}    Test Story    Story description    draft
