# US007 — E2E test specification (Robot Framework)

**Owner:** tester. Implemented in `tests/e2e/REQ002_dashboard/US007_view_project_dashboard.robot`.
