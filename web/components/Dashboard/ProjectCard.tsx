...
export const ProjectCard: React.FC<ProjectCardProps> = ({ project }) => {
  return (
    ...
    >
      <article data-testid="project-card" className="border border-gray-200 rounded-lg p-6 shadow-sm hover:shadow-md transition-shadow bg-white flex flex-col h-full">
