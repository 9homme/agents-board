*** Settings ***
Documentation    E2E tests for US012 — Navigate to project detail page with tabs.
...
E2E-US012-002 Direct URL with tab=user-stories survives browser refresh
