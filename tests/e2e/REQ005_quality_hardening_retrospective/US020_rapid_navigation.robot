*** Settings ***
Documentation    E2E tests for US020 — Harmonise FE hooks on AbortController.
...
...
...              FCT-US020-003 through FCT-US020-010 with MSW-simulated delay). One scenario
...
...              replicate. See US020_e2e_tests.md §"Why e2e" for the full rationale.
...
...
Suite Setup      Setup US020 Suite
Suite Teardown   Teardown US020 Suite
...
Setup US020 Suite
    ...
    ${name1}=          Set Variable    REQ005 US020 Alpha ${random}
...
E2E-US020-001 Rapid project navigation does not show stale data or error state
    ...
    ...                (FCT-US020-004/006) are the authoritative abort-correctness proofs.
    [Tags]    US020    REQ005    regression
