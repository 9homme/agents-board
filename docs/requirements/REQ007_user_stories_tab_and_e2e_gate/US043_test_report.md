...
**Story:** US043 — User story detail and tasks drawer
...
**Summary:** 174 passed, 0 failed (23 suites — includes US042 and US043 FE tests)
...
| Test ID | Test Name | Result |
|---|---|---|
| E2E-US043-001 | Clicking a card opens detail drawer with tasks | PASS |
| E2E-US043-002 | Switching stories and closing the drawer (incl. step 3a: empty-state sub-assertion) | PASS |

**Note — E2E-US043-003:** Removed from spec (tester revision 1). Empty-state AC is covered by step 3a of E2E-US043-002 (e2e layer) + FCT-002 (FE component) + IT-004 (BE integration). No standalone test needed.
