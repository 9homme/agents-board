# US032 — Backfill `message.go` error-routing tests
...
- **`project_tools.go` / `document_tools.go` / `task_tools.go` / `user_story_tools.go`** — US028–US031.
