...
- **Architecture cite:** US004 AC "Lint exits clean".
...
- **Given:** All existing tests for US001/US002/US003 are present and unmodified in behaviour.
- **When:** The command completes.
- **Then:**
  - Exit status is 0.
...
- **Architecture cite:** US004 AC "No behaviour change in production code under -race".
...
- **Architecture cite:** US004 AC "Specific finding categories are resolved correctly — noctx (11)".
...
- **Architecture cite:** US004 AC "unused cluster in handler_test.go is triaged first".
...
- **Architecture cite:** US004 AC "Specific finding categories are resolved correctly — gocritic (5)".
...
- **Architecture cite:** US004 AC "Specific finding categories are resolved correctly — errcheck (4)".
...
- **Architecture cite:** US004 AC "Specific finding categories are resolved correctly — errorlint (3)".
...
- **Architecture cite:** US004 AC "Specific finding categories are resolved correctly — gosec (1)"; US004 AC "Any remaining suppressions are explicit and justified".
...
- **Architecture cite:** US004 AC "Specific finding categories are resolved correctly — revive (1)".
...
- **Architecture cite:** US004 AC "Any remaining suppressions are explicit and justified".
