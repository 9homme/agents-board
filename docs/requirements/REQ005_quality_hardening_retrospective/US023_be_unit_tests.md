# US023 — Backend unit & integration test specification

**For BE Dev:** US023 ships path (b) — appending the canonical-path edit policy block to six agent definition files. Tests are grep-style structural assertions verifying the block is present and has consistent wording across all six files.
...
|---|---|---|---|---|
| `po-ba.md` contains canonical-path policy block | unit | UT-US023-001 | `.claude/agents/po-ba.md` | required heading and body text present |
| `system-architect.md` contains canonical-path policy block | unit | UT-US023-002 | `.claude/agents/system-architect.md` | same |
| `tech-lead.md` contains canonical-path policy block | unit | UT-US023-003 | `.claude/agents/tech-lead.md` | same |
| `tester.md` contains canonical-path policy block | unit | UT-US023-004 | `.claude/agents/tester.md` | same |
| `be-dev.md` contains canonical-path policy block | unit | UT-US023-005 | `.claude/agents/be-dev.md` | same |
| `fe-dev.md` contains canonical-path policy block | unit | UT-US023-006 | `.claude/agents/fe-dev.md` | same |
| All six blocks have identical wording | unit | UT-US023-007 | all six agent files | diff of the extracted blocks is empty |
...
### UT-US023-001 through UT-US023-006 — Each agent file contains the policy block
...
### UT-US023-007 — All six blocks are word-for-word identical
