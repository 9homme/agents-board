*** Settings ***
Documentation    E2E tests for US008 — Live e2e stack-up.
...
...              E2E-US008-001: API server is healthy and returns project list (RequestsLibrary).
...              E2E-US008-002: Web UI is reachable and renders the dashboard (Browser library).
...
...              E2E-US008-003 (documented in US008_e2e_tests.md) is NOT a Robot test case —
