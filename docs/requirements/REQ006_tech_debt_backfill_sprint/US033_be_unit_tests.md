# US033 — Backend unit & integration test specification
...
- **Architecture cite:** architecture.md §4.4; US033 AC item 1
...
- **Then:**
  - `ok` is `true`
  - `h` is non-nil
- **Architecture cite:** US033 AC item 2
...
- **Architecture cite:** US033 AC item 3
...
- **Then:**
  - `ok` is `false`
  - `h` is `nil`
- **Architecture cite:** US033 AC item 4
...
- **Architecture cite:** US033 AC item 5
...
- **Architecture cite:** architecture.md §4.4 special case; US033 AC item 6; architecture.md §13.1 R-5
...
- **Architecture cite:** US033 AC item 7
...
- **Architecture cite:** architecture.md §4.4 concurrent test note; US033 AC item 8; must use `sync.WaitGroup` + ≥100 goroutines
...
- **Then:**
  ...
  - `err2` is nil
  - `received` equals `msg`
- **Architecture cite:** US033 AC item 9
...
- **Architecture cite:** architecture.md §4.4 `TestSession_QueueMessage_FullReturnsError`; US033 AC item 10; `server.go:59` capacity=100
...
- **Architecture cite:** US033 AC item 11
...
- **Architecture cite:** architecture.md §4.4 context-cancel choice; US033 AC item 12
...
- **Then:** `ok` is `false`
- **Architecture cite:** US033 AC item 13; tech_debt.md line 69 (`RemoveSession` at 0%)
...
- **Architecture cite:** US033 AC item 14
...
- **Then:** test must pass cleanly under `go test -race ./internal/mcp`
- **Architecture cite:** architecture.md §4.4 concurrent test note; US033 AC item 15
