# US009 — E2E test specification (Robot Framework)

**Owner:** tester. Implemented in `tests/e2e/REQ003_status_state_machine/US009_story_state_machine.robot`.
