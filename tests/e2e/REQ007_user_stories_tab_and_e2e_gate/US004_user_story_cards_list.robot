*** Settings ***
Documentation    E2E tests for US004 — User Story cards list.
Library          Browser
Library          String
...
Setup US004 Suite
    ...
    ${proj_resp}=      Create Project Tool    ${session_id}    US004 Project ${random}
    ...
    # Project 2: Empty
    ${proj2_resp}=     Create Project Tool    ${session_id}    US004 Empty Project
