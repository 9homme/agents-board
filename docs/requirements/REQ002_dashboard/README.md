...
## User Stories
- `US007_view_project_dashboard.md` - View list of projects as cards

## Tasks
| Task | Title | Track | Status | Blocked By |
|---|---|---|---|---|
| `US007_be_service_rename_and_api_server_scaffold.md` | Scaffold API server and rename service | BE | pending | |
| `US007_be_get_projects_api.md` | Implement GET /api/v1/projects | BE | pending | `US007_be_service_rename_and_api_server_scaffold.md` |
| `US007_fe_scaffold_api_client.md` | Scaffold Next.js API client & MSW mocks | FE | pending | |
| `US007_fe_dashboard_page.md` | Implement dashboard UI | FE | pending | `US007_fe_scaffold_api_client.md` |
