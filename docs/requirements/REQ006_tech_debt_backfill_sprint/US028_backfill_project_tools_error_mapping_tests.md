# US028 — Backfill `project_tools.go` error-mapping tests
...
- **`document_tools.go` / `task_tools.go` / `user_story_tools.go` / `message.go`** — US029, US030, US031, US032 respectively.
