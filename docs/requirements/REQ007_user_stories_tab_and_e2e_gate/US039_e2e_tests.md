# US039 — E2E test specification (Robot Framework)

**Owner:** tester. Implemented in `tests/e2e/REQ007_user_stories_tab_and_e2e_gate/US039_migrations_at_startup.robot`.
...
## Scenarios
### E2E-US039-001 — API starts and serves requests immediately on a fresh migrated database
- **Tag:** US039, smoke
