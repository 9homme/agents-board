# US029 — Backfill `document_tools.go` error-mapping tests
...
- **`project_tools.go` / `task_tools.go` / `user_story_tools.go` / `message.go`** — US028, US030, US031, US032.
