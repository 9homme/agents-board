...
- **Then:** Returns `true`.
- **Architecture cite:** US002 AC "Sign-off cycle transitions".
...
- **Then:** Returns `true`.
- **Architecture cite:** US002 AC "Circuit breaker transition".
...
- **Architecture cite:** US002 AC "Enforce initial state on creation".
