...
- **If a new finding surfaces:** do NOT fold the fix into US012. Raise a follow-up story per architecture.md §6.5.
...
- **Architecture cite:** architecture.md §10.1 (3-clean-run bar); US012 AC "all existing tests pass"
...
- **Architecture cite:** US012 AC "go build ./... succeeds"
