# US012 — E2E test specification (Robot Framework)

**Owner:** tester. Implemented in `tests/e2e/REQ004_project_detail_page/US012_navigate.robot`.
...
### E2E-US012-001 — Dashboard click-through to detail page then tab switch
- **Tag:** US012, smoke, regression
- **Preconditions:**
...
### E2E-US012-002 — Direct URL to detail page with `?tab=user-stories` survives browser refresh
- **Tag:** US012, regression
- **Preconditions:** same as E2E-US012-001; use the same `projectId` from setup.
- **Setup (data):** reuse the project created in E2E-US012-001 suite setup, or create a new one.
- **Steps:**
